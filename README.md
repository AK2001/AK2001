...
I am a Python developer, focusing on Machine Learning & Deep Learning.
...
- "Car make and model classification from Image":
  - My BSc thesis which I experimented with CNNs for the first time 🧪 - [repository](https://github.com/AK2001/Car-Model-Classification-from-Image)

- A similarity search system build upon a SQL database containing millions of records
